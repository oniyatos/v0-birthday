...
export function HeroSection({ babyName, eventDate }: HeroSectionProps) {
  ...
  return (
    <section ref={ref} className="min-h-[100svh] flex flex-col items-center justify-center px-4 pt-10 pb-32 mb-10 relative perspective-[2000px] z-20">
      ...
      >
        ...
        >
          ...
          >
            ...
            <p className="text-sm tracking-[0.3em] uppercase font-bold text-slate-500">Welcome to my</p>
            <Sparkles className="w-5 h-5 text-yellow-400 animate-pulse" />
          </motion.div>
          ...
          >
            <h1 className="text-5xl md:text-6xl font-black gradient-text tracking-tight pb-2">1st Birthday</h1>
          ...
          <motion.div style={{ transform: "translateZ(40px)" }}>
            <h2 className="text-5xl md:text-6xl gradient-text mb-2 font-bold" style={{ fontFamily: "var(--font-cursive)" }}>{babyName}</h2>
            <p className="text-lg mb-6 font-medium text-slate-500">Tiệc Thôi Nôi</p>
      ...
      >
        <p className="text-xs font-bold tracking-[0.2em] uppercase text-slate-400">Scroll to explore</p>
        <motion.div
          animate={{ y:[0, 8, 0] }}
