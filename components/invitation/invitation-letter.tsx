			...
			>
				<div className='inline-flex items-center gap-3 mb-3'>
					<motion.div
						...
						style={{
							background: 'linear-gradient(90deg, transparent, #FFB6C1)',
						}}
					/>
				...
				>
					...
					>
						...
						<div className='absolute inset-0 rounded-full flex items-center justify-center'>
							...
							>
								<Heart
									className='w-10 h-10 text-pink-400 fill-pink-300'
									style={{
					...
					>
						...
						<p>
							Nhân dịp này chúng tôi xin kính mời quý khách đến dự bữa tiệc{' '}
							<span className='font-semibold' style={{ color: '#FFB6C1' }}>
								Thôi Nôi
							</span>{' '}
							để cùng chia sẻ niềm vui và chúc phúc cho bé.
						</p>

						<p>
							Sự hiện diện của quý khách là niềm vui của gia đình chúng tôi.
						</p>
					</motion.div>
					...
					>
						...
						<div
							...
							style={{
								background:
									'linear-gradient(90deg, transparent, rgba(135, 206, 235, 0.5), transparent)',
							}}
						/>
						...
						<p
							className='text-4xl gradient-text-static'
							style={{ fontFamily: 'var(--font-cursive)' }}
						>
							{parentNames}
						</p>
