...
export function GiftingSection() {
	...
	const bankInfo = {
		...
		accountNumber: '1999 0807 99999',
		accountName: 'Le Phuong Anh',
	}
		...
		<section className='py-20 px-4'>
			...
			>
				...
				>
					...
					<h3 className='text-3xl font-semibold' style={{ color: '#4a6b8a' }}>
						GỬI QUÀ CHO BÉ
					</h3>
			...
			>
				...
				>
					...
					<motion.div
						...
						style={{
							background:
								'linear-gradient(135deg, rgba(255,255,255,0.8), rgba(248,251,255,0.6))',
						}}
					>
						...
						>
							<div className='px-7 pb-7 space-y-5'>
								...
								<motion.p
									...
									style={{ color: '#6b8cae' }}
								>
									Sự hiện diện của quý khách là món quà quý giá nhất. Nếu muốn
									gửi quà tặng bé, xin vui lòng quét mã QR dưới đây
								</motion.p>
								...
								<motion.div
									...
									style={{
										background:
											'linear-gradient(135deg, rgba(255,255,255,0.95), rgba(248,251,255,0.9))',
										boxShadow:
											'0 8px 32px rgba(251, 191, 36, 0.15), inset 0 2px 0 rgba(255,255,255,1)',
									}}
								>
									<div
									...
									>
										<div className='text-center'>
											<img
												src='/qr.jpg'
												alt='QR Code'
												className='w-[90%] h-[90%] mx-auto mb-2'
											/>{' '}
										...
										{/* Decorative corners */}
										<div
											className='absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 rounded-tl-md'
											style={{ borderColor: '#87CEEB' }}
										/>
										<div
											className='absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 rounded-tr-md'
											style={{ borderColor: '#FFB6C1' }}
										/>
										<div
											className='absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 rounded-bl-md'
											style={{ borderColor: '#FFF9C4' }}
										/>
										<div
											className='absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 rounded-br-md'
											style={{ borderColor: '#87CEEB' }}
										/>
									</div>
								</motion.div>
								...
								>
									...
									<div
										...
										style={{
											background:
												'linear-gradient(90deg, transparent, rgba(135, 206, 235, 0.3), transparent)',
										}}
									/>
									<div className='flex justify-between items-center'>
										<span className='text-sm' style={{ color: '#6b8cae' }}>
								...
								<motion.p
									...
									style={{ color: '#FFB6C1' }}
								>
									<span>Chân thành cảm ơn quý khách</span>
								</motion.p>
							</div>
						</motion.div>
					)}
